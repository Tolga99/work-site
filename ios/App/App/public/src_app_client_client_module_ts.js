...
/* harmony import */ var _client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./client */ 91910);
...
const routes = [
    {
        path: '',
        component: _client__WEBPACK_IMPORTED_MODULE_0__.Client
    }
];
let ClientRoutingModule = class ClientRoutingModule {
};
ClientRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony import */ var _client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./client */ 91910);
...
ClientModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.IonicModule,
            _client_routing_module__WEBPACK_IMPORTED_MODULE_0__.ClientRoutingModule, _shared_shared_module__WEBPACK_IMPORTED_MODULE_2__.SharedModule, ng_apexcharts__WEBPACK_IMPORTED_MODULE_6__.NgApexchartsModule, _angular_common__WEBPACK_IMPORTED_MODULE_7__.CommonModule,
        ],
        declarations: [_client__WEBPACK_IMPORTED_MODULE_1__.Client]
    })
], ClientModule);
...
let Client = class Client {
  ...
  ionViewDidEnter() {
    ...
    return (0,C_Users_t_olg_Desktop_Tolga_Ov_Projets_DevisApp_work_site_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let clients = yield _this.storageService.get('Contacts');
      _this.client = clients.find(a => a.userId == _this.userId);
      let chantiers = yield _this.storageService.get('Chantiers');
      _this.chantiers = chantiers.filter(a => a.clientId === _this.client.userId);
      let i = 0;

      _this.chantiers.forEach(element => {
        for (let index = 0; index < element.factures?.length; index++) {
          _this.chartOptions.xaxis.categories[i] = element.factures[index].factureName;
          _this.chartOptions.series[1].data[i] = element.factures[index].totalPrice;
          _this.chartOptions.series[0].data[i] = _this.GetAllReceivedMoney(element.factures[index]);
          _this.chartOptions.series[2].data[i] = element.factures[index].totalPrice - _this.GetAllReceivedMoney(element.factures[index]);
          i++;
        }
      });

      console.log(_this.chartOptions.xaxis.categories);
    })();
  }
  ...
  ngOnInit() {
    ...
    return (0,C_Users_t_olg_Desktop_Tolga_Ov_Projets_DevisApp_work_site_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let clients = yield _this2.storageService.get('Contacts');
      _this2.client = clients.find(a => a.userId == _this2.userId);
      let chantiers = yield _this2.storageService.get('Chantiers');
      _this2.chantiers = chantiers.filter(a => a.clientId === _this2.client.userId);
      let i = 0;

      _this2.chantiers.forEach(element => {
        for (let index = 0; index < element.factures?.length; index++) {
          _this2.chartOptions.xaxis.categories[i] = element.factures[index].factureName;
          _this2.chartOptions.series[1].data[i] = element.factures[index].totalPrice;
          _this2.chartOptions.series[0].data[i] = _this2.GetAllReceivedMoney(element.factures[index]);
          _this2.chartOptions.series[2].data[i] = element.factures[index].totalPrice - _this2.GetAllReceivedMoney(element.factures[index]);
          i++;
        }
      });

      window.dispatchEvent(new Event('resize'));
      console.log(_this2.chartOptions.xaxis.categories);
    })();
  }
...
/***/ 25970:
/*!***********************************************!*\
  !*** ./src/app/client/client.scss?ngResource ***!
  \***********************************************/
/***/ ((module) => {

module.exports = "#chart {\n  max-width: 650px;\n  margin: 35px auto;\n}\n\nfieldset {\n  border: 0;\n}\n\nfieldset.display {\n  border: 1px solid #cccccc;\n}\n\n.tabHeader {\n  background-color: orange;\n  color: white;\n  text-align: center;\n  border: 1px solid lightgray;\n  border-radius: 4px;\n}\n\n.tab {\n  margin: 10px;\n  border-bottom: 1px solid black;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 2298:
/*!***********************************************!*\
  !*** ./src/app/client/client.html?ngResource ***!
  \***********************************************/
/***/ ((module) => {

module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title class=\"ion-text-center\">{{'client' | translate}}</ion-title>\n    <dx-button slot=\"start\" (click)=\"GoBack()\" icon=\"fas fa-arrow-left\" style=\"background-color: orange;\">\n    </dx-button>\n    <dx-button slot=\"end\" (click)=\"EditContact()\" style=\"background-color: orange;\" icon=\"fas fa-pen\">\n    </dx-button>\n    <ion-title slot=\"\" style=\"font-size:smaller; text-align: center;\">{{GetName()}}</ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content [fullscreen]=\"true\" style=\"background-color: white;\">\n  <div class=\"tab\">\n  <div class=\"card-header tabHeader\">\n    {{'profile' | translate}}\n  </div>\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'fName' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.firstName}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'name' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.lastName.toUpperCase()}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'address' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.address}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'phone' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.phone}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'mail' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.mail}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'tva' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.tva}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'iban' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.iban}}</ion-label>\n  </ion-item>\n\n  <ion-item>\n    <ion-label position=\"fixed\" style=\"font-weight: lighter;\">{{'bic' | translate}} : </ion-label>\n    <ion-label style=\"font-weight: bolder;\">{{client?.bic}}</ion-label>\n  </ion-item>\n</div>\n<div class=\"tab\">\n  <div class=\"card-header tabHeader\">\n    {{'history' | translate}}\n  </div>\n  <div class=\"col-auto table-wrapper-scroll-y my-custom-scrollbar\">\n    <div [hidden]=\"chantiers != null && chantiers.length > 0\">\n      <ion-label style=\"color: gray;\">\n        {{'noData' | translate}}</ion-label>\n    </div>\n    <table mat-table class=\"table table-bordered table-striped mb-0\">\n      <thead>\n        <tr>\n          <th *ngFor=\"let head of headElements\" scope=\"col\">{{head}} </th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr mdbTableCol *ngFor=\"let el of chantiers\">\n          <!-- <th scope=\"row\">{{el.id}}</th> -->\n          <td>{{el.worksiteName}}</td>\n          <td>{{GetName()}}</td>\n          <td>{{el.dateStart}}</td>\n          <td>{{el.address}}</td>\n          <td>{{el.isFinished}}</td>\n\n          <td></td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n  </div>\n  <div class=\"tab\">\n  <div class=\"card-header tabHeader\">\n    {{'achats' | translate}}\n  </div>\n  <div id=\"chart\">\n    <apx-chart [series]=\"chartOptions.series\" [chart]=\"chartOptions.chart\" [dataLabels]=\"chartOptions.dataLabels\"\n      [plotOptions]=\"chartOptions.plotOptions\" [yaxis]=\"chartOptions.yaxis\" [legend]=\"chartOptions.legend\"\n      [fill]=\"chartOptions.fill\" [stroke]=\"chartOptions.stroke\" [tooltip]=\"chartOptions.tooltip\"\n      [xaxis]=\"chartOptions.xaxis\"></apx-chart>\n  </div>\n</div>\n</ion-content>";
